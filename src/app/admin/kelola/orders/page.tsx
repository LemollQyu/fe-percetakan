...
function AdminOrderCard({ order }: { order: any }) {
  ...
  const orderCode = order?.order_code?.code ?? order?.code ?? order.id;
      ...
      <div className="px-4 pt-3 pb-3">
        ...
        <div className="flex items-start justify-between gap-2 mb-3">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            <button
              type="button"
              onClick={() => router.push(`/admin/kelola/orders/${orderCode}`)}
              className="w-7 h-7 rounded-xl bg-stone-100 flex items-center justify-center active:scale-90 transition hover:bg-stone-200"
