            ...
            <Section
              ...
              badge={
                <button
                  ...
                  className="inline-flex items-center gap-1 rounded-xl bg-violet-100 border border-violet-200 px-2.5 py-1 text-[11px] font-semibold text-violet-700 active:scale-95 transition hover:bg-violet-200"
                >
                  <svg
                    className="w-3 h-3"
                    fill="none"
